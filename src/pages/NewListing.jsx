...
import { FaRegEdit, FaImage, FaBullhorn, FaMoneyBillAlt } from 'react-icons/fa';
...
const NewListing = () => {
  ...
  const icons = [
    <FaRegEdit className="text-indigo-600 mt-1" />,
    <FaImage className="text-blue-600 mt-1" />,
    <FaBullhorn className="text-green-600 mt-1" />,
    <FaMoneyBillAlt className="text-yellow-600 mt-1" />
  ];
